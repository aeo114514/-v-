...
Notify("无敌乐子", "作者乐子", "rbxassetid://2605113602", 3)
Notify("永久免费", "祝你玩的开心","rbxassetid://2605113602",3)
Notify("永久免费", "没有盈利","rbxassetid://2605113602",3)
Notify("sz", "sz","rbxassetid://2605113602",3)
Notify("拒绝跑路", "拒绝倒卖","rbxassetid://2605113602",3)
Notify("启动完成", "祝你玩的开心","rbxassetid://2605113602",5)

local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/XiaoYunCN/UWU/main/Library%2FSilent%20ui'))()
local Window = Library:new("无敌三玖 X");

local creds = Window:Tab("公告",'114514')
local bin = creds:section("信息",true)
local about = creds:section("作者",true)

local Main = Window:Tab("主要",'16060333448')
local General = Main:section("人物",true)
...
about:Label("作者三玖")
about:Label("作者qq2605113602")
about:Label("正在努力优化")
about:Label("请勿倒卖")
about:Button("复制作者QQ", function()
    setclipboard("114514")
end)
about:Button("作者  ", function()
    setclipboard("作者")
end)
